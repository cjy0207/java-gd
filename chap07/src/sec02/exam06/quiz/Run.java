...
//	일하는 중입니다.
	...
	public static void main(String[] args) {
		 ...
		 SchoolMember[] members = new SchoolMember[3];
		 
		 members[0] = new Student();
		 members[1] = new Teacher();
		 members[2] = new Staff();
		 
		 for(SchoolMember m : members) {
			 m.introduce();
			 
			 if(m instanceof Student student) student.study();
			 else if(m instanceof Teacher teacher) teacher.teach();
			 else if(m instanceof Staff staff) staff.work();
		 }
