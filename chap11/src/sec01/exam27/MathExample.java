...
public class MathExample {
	...
	public static void main(String[] args) {
		...
		System.out.println(Math.pow(5, 0));   // 1.03
		...
		double num2 = Math.pow(10, num-1);
		double result = Math.round(value * num2) / num2;
		
		System.out.println(result);
		
		
		//String.format
		String format = "%." + (num-1) + "f";
		String result2 = String.format(format, value);
